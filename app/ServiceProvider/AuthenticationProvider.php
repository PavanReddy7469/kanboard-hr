...
class AuthenticationProvider implements ServiceProviderInterface
{
    ...
    public function getProjectAccessMap()
    {
        ...
        $acl->add('BoardAjaxController', 'save', Role::PROJECT_MANAGER);
        $acl->add('BoardPopoverController', '*', Role::PROJECT_MEMBER);
        $acl->add('TaskPopoverController', '*', Role::PROJECT_MEMBER);
        $acl->add('CalendarController', 'save', Role::PROJECT_MANAGER);
        ...
        $acl->add('ExternalTaskCreationController', '*', Role::PROJECT_MANAGER);
        ...
        $acl->add('SubtaskConverterController', '*', Role::PROJECT_MANAGER);
        $acl->add('SubtaskRestrictionController', '*', Role::PROJECT_MANAGER);
        ...
        $acl->add('TaskBulkMoveColumnController', '*', Role::PROJECT_MANAGER);
        $acl->add('TaskBulkChangePropertyController', '*', Role::PROJECT_MANAGER);
        ...
        $acl->add('TaskMovePositionController', '*', Role::PROJECT_MANAGER);
        $acl->add('TaskReorderController', '*', Role::PROJECT_MANAGER);
    ...
    public function getApplicationAccessMap()
    {
        ...
        $acl->add('ConfigController', '*', Role::APP_MANAGER);
        $acl->add('TagController', '*', Role::APP_MANAGER);
        $acl->add('PluginController', '*', Role::APP_MANAGER);
        $acl->add('CurrencyController', '*', Role::APP_MANAGER);
        $acl->add('GroupListController', '*', Role::APP_MANAGER);
        $acl->add('GroupCreationController', '*', Role::APP_MANAGER);
        $acl->add('GroupModificationController', '*', Role::APP_MANAGER);
        $acl->add('LinkController', '*', Role::APP_MANAGER);
        $acl->add('ProjectCreationController', '*', Role::APP_MANAGER);
        $acl->add('ProjectUserOverviewController', '*', Role::APP_MANAGER);
        $acl->add('TwoFactorController', 'disable', Role::APP_MANAGER);
        $acl->add('UserImportController', '*', Role::APP_MANAGER);
        $acl->add('UserCreationController', '*', Role::APP_MANAGER);
        $acl->add('UserListController', '*', Role::APP_MANAGER);
        $acl->add('UserStatusController', '*', Role::APP_MANAGER);
        $acl->add('UserCredentialController', array('changeAuthentication', 'saveAuthentication', 'unlock'), Role::APP_MANAGER);
        $acl->add('UserInviteController', array('show', 'save'), Role::APP_MANAGER);
