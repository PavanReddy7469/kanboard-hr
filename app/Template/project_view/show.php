...
<?php if (! empty($project['description'])): ?>
    ...
    <?php /* The controller never passes $values or $errors, so these emitted two
             "Undefined variable" warnings straight onto the page. Upstream defect;
             guarded rather than changed, so any plugin attaching to this hook still
             receives the shape it expects. */ ?>
    <?= $this->hook->render('template:project:view:form', array(
