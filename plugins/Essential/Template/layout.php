...
<html lang="<?= $this->app->jsLang() ?>">
    <head>
        ...
        <link rel="icon" type="image/png" href="<?= $this->url->dir() ?>assets/img/superbee_logo.png?v=2">
        <link rel="shortcut icon" type="image/png" href="<?= $this->url->dir() ?>assets/img/superbee_logo.png?v=2">
        <link rel="apple-touch-icon" href="<?= $this->url->dir() ?>assets/img/superbee_logo.png?v=2">
