...
CREATE TABLE IF NOT EXISTS public.taskmanager_deliverables (
...
CREATE INDEX IF NOT EXISTS taskmanager_deliverables_task_idx ON public.taskmanager_deliverables(task_id);
CREATE INDEX IF NOT EXISTS taskmanager_deliverables_project_idx ON public.taskmanager_deliverables(project_id, status);
